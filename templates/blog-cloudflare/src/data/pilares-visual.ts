...
export const PILLARS: readonly PillarVisual[] = [
	...
	{ slug: "saude-mental", label: "Memória, sono e humor", emoji: "🧠", color: "#7E57C2", featured: true },
	{ slug: "doencas-cronicas", label: "Doenças crônicas", emoji: "❤️", color: "#E53935", featured: true },
	{ slug: "vida-plena", label: "Bem-estar e propósito 55+", emoji: "🌅", color: "#FB8C00", featured: true },
